...
# We implement the following reparametrization module based on the code provided in https://https://github.com/GeorgeCazenavette/mtt-distillation.
class ReparamModule(nn.Module):
    ...
    def __init__(self, module):
        ...
        self._param_infos = tuple(param_infos) # (('module.up_layers.0', 'weight'), ('module.up_layers.0', 'bias'), ..., ('module.output_layer', 'bias'))
        self._shared_param_infos = tuple(shared_param_infos) # ()
        self._param_numels = tuple(param_numels) # (32768, 64, 73728, 64, 64, 36864, 64, 64, 8192, 32, 18432, 32, 32, 9216, 32, 32, 2048, ..., 8, 1)
        self._param_shapes = tuple(param_shapes) # (torch.Size([128, 64, 2, 2]), torch.Size([64]), torch.Size([64, 128, 3, 3]), ..., torch.Size([1, 8, 1, 1]), torch.Size([1]))
